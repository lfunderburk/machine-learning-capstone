...
class CarSalesSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.goodcarbadcar.net/2020-canada-vehicle-sales-figures-by-model/']
    
    def parse(self, response):
        table = response.xpath('//*[@id="table_1"]/tbody')
        rows = table.xpath('//tr[contains(@id,"table_6123")]')
